# Task 1: Update github_repo_manager to support connector_name

- Group: 1 | Mode: sequential | Model: sonnet
- Skill: @golang-pro | Critical: no | Depends: none
- Sandbox: /tmp/3agents/task-1/ | Source: . | Output: docs/fixes/connector-name-test/

## Files
- `internal/queue/managers/github_repo_manager.go` - add connector_name support
