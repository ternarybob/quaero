...
func (e *CrawlerExecutor) Validate(job *models.JobModel) error {
...
func (e *CrawlerExecutor) Execute(ctx context.Context, job *models.JobModel) error {
	...
	e.publishCrawlerJobLog(ctx, parentID, "info", fmt.Sprintf("Starting crawl of URL: %s (depth: %d)", seedURL, job.Depth), map[string]interface{}{
		"url":          seedURL,
		"depth":        job.Depth,
	...
	e.jobMgr.AddJobLog(ctx, job.ID, "info", fmt.Sprintf("Starting crawl of URL: %s (depth: %d)", seedURL, job.Depth))
...
func (e *CrawlerExecutor) extractCrawlConfig(config map[string]interface{}) (*models.CrawlConfig, error) {
...
func (e *CrawlerExecutor) renderPageWithChromeDp(ctx context.Context, browserCtx context.Context, url string, logger arbor.ILogger) (string, int, error) {
...
func (e *CrawlerExecutor) spawnChildJob(ctx context.Context, parentJob *models.JobModel, childURL string, crawlConfig *models.CrawlConfig, sourceType, entityType string, linkIndex int, logger arbor.ILogger) error {
...
func (e *CrawlerExecutor) publishCrawlerJobLog(ctx context.Context, jobID, level, message string, metadata map[string]interface{}) {
...
func (e *CrawlerExecutor) publishCrawlerProgressUpdate(ctx context.Context, job *models.JobModel, status, activity, currentURL string) {
	if e.eventService == nil {
		return
	}
...
func (e *CrawlerExecutor) publishLinkDiscoveryEvent(ctx context.Context, job *models.JobModel, linkStats *crawler.LinkProcessingResult, currentURL string) {
	if e.eventService == nil {
		return
	}
...
func (e *CrawlerExecutor) publishJobSpawnEvent(ctx context.Context, parentJob *models.JobModel, childJobID, childURL string) {
	if e.eventService == nil {
		return
	}
