	...
	tests := []struct {
		...
		},
		{
			...
			expectedReport: &jobtypes.JobStatusReport{
				...
				FailedChildren:     0,
				RunningChildren:    0,
				ProgressText:       "Completed: 10 | Failed: 0 | Running: 0 | Total: 10",
				Errors:             []string{},
				Warnings:           []string{},
			},
		},
		{
			...
			expectedReport: &jobtypes.JobStatusReport{
				...
				FailedChildren:     2,
				RunningChildren:    31,
				ProgressText:       "Completed: 11 | Failed: 2 | Running: 31 | Total: 44",
				Errors:             []string{},
				Warnings:           []string{},
			},
		},
		{
			...
			expectedReport: &jobtypes.JobStatusReport{
				...
				FailedChildren:     5,
				RunningChildren:    0,
				ProgressText:       "Completed: 0 | Failed: 5 | Running: 0 | Total: 5",
				Errors:             []string{},
				Warnings:           []string{},
			},
		},
		...
		},
		{
			...
			expectedReport: &jobtypes.JobStatusReport{
				...
				ProgressText:       "Completed: 7 | Failed: 5 | Running: 0 | Total: 10",
				Errors:             []string{},
				Warnings:           []string{},
			},
		},
