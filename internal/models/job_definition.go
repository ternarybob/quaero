...
const (
	...
	JobDefinitionTypePortfolio              JobDefinitionType = "portfolio"                // Unified portfolio worker (accepts ticker list or navexa portfolio)
	JobDefinitionTypePortfolioList          JobDefinitionType = "portfolio_list"           // Fetch all portfolios for the user
	JobDefinitionTypePortfolioFetch         JobDefinitionType = "portfolio_fetch"          // Fetch specific portfolio by name with holdings
	JobDefinitionTypePortfolioHoldings      JobDefinitionType = "portfolio_holdings"       // Fetch holdings for a portfolio
	JobDefinitionTypePortfolioPerformance   JobDefinitionType = "portfolio_performance"    // Fetch P/L performance for a portfolio
	JobDefinitionTypePortfolioReview        JobDefinitionType = "portfolio_review"         // LLM-generated portfolio review from portfolio documents
	JobDefinitionTypeNavexaPortfolio        JobDefinitionType = "navexa_portfolio"         // Fetch portfolio by name from Navexa API
...
func IsValidJobDefinitionType(jobType JobDefinitionType) bool {
	...
	case JobDefinitionTypeCrawler, JobDefinitionTypeSummarizer, JobDefinitionTypeCustom, JobDefinitionTypePlaces,
		...
		JobDefinitionTypePortfolio, JobDefinitionTypePortfolioList, JobDefinitionTypePortfolioFetch, JobDefinitionTypePortfolioHoldings, JobDefinitionTypePortfolioPerformance,
		JobDefinitionTypePortfolioReview, JobDefinitionTypeNavexaPortfolio, JobDefinitionTypeManager:
		return true
	default:
		return false
	}
