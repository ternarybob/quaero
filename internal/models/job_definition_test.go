...
func TestAllWorkerTypes(t *testing.T) {
	...
	expectedCount := 51 // Added stock analysis worker types (announcement download, annual report, ratings, portfolios, etc.)
	...
	expectedTypes := map[WorkerType]bool{
		...
		WorkerTypeMarketAnnouncements:        true,
		WorkerTypeMarketData:                 true,
		WorkerTypeMarketNews:                 true,
		WorkerTypeMarketDirectorInterest:     true,
		WorkerTypeMarketFundamentals:         true,
		WorkerTypeMarketMacro:                true,
		WorkerTypeMarketCompetitor:           true,
		WorkerTypeMarketSignal:               true,
		...
		WorkerTypeMarketAnnouncementDownload: true,
		WorkerTypeMarketAnnualReport:         true,
		WorkerTypeSignalAnalysis:             true,
		WorkerTypeOutputFormatter:            true,
		WorkerTypePortfolio:                  true,
		WorkerTypeNavexaPortfolio:            true,
		WorkerTypeRatingBFS:                  true,
		WorkerTypeRatingCDS:                  true,
		WorkerTypeRatingNFR:                  true,
		WorkerTypeRatingPPS:                  true,
		WorkerTypeRatingVRS:                  true,
		WorkerTypeRatingOB:                   true,
		WorkerTypeRatingComposite:            true,
	}
