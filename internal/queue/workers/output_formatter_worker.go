// -----------------------------------------------------------------------
// OutputFormatterWorker - Prepares output documents for email delivery
...
type OutputFormatterWorker struct {
...
// Compile-time assertion: OutputFormatterWorker implements DefinitionWorker interface
var _ interfaces.DefinitionWorker = (*OutputFormatterWorker)(nil)

// NewOutputFormatterWorker creates a new output formatter worker
func NewOutputFormatterWorker(
	searchService interfaces.SearchService,
	documentStorage interfaces.DocumentStorage,
	logger arbor.ILogger,
	jobMgr *queue.Manager,
	...
	serverHost string,
	serverPort int,
) *OutputFormatterWorker {
	return &OutputFormatterWorker{
...
func (w *OutputFormatterWorker) GetType() models.WorkerType {
	return models.WorkerTypeOutputFormatter
}

// ReturnsChildJobs returns false as this worker executes synchronously
func (w *OutputFormatterWorker) ReturnsChildJobs() bool {
	return false
}

// ValidateConfig validates the step configuration
func (w *OutputFormatterWorker) ValidateConfig(step models.JobStep) error {
...
func (w *OutputFormatterWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
	stepConfig := step.Config
	if stepConfig == nil {
...
func (w *OutputFormatterWorker) CreateJobs(ctx context.Context, step models.JobStep, jobDef models.JobDefinition, stepID string, initResult *interfaces.WorkerInitResult) (string, error) {
...
func (w *OutputFormatterWorker) processDocuments(
	ctx context.Context,
	step models.JobStep,
...
func (w *OutputFormatterWorker) buildOutputDocument(
