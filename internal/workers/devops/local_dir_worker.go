...
func (w *LocalDirWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
	...
	extensions := workerutil.GetStringSliceConfig(stepConfig, "extensions", []string{
	...
	excludePaths := workerutil.GetStringSliceConfig(stepConfig, "exclude_paths", []string{
		"vendor/", "node_modules/", ".git/", "dist/", "build/",
		"__pycache__/", ".venv/", "venv/", ".tox/",
		"target/", ".gradle/", ".mvn/",
		".idea/", ".vscode/", ".vs/",
	})
	maxFiles := workerutil.GetIntConfig(stepConfig, "max_files", 10000)
	maxFileSize := workerutil.GetIntConfig(stepConfig, "max_file_size", 1024*1024) // 1MB default
...
// Note: Helper functions workerutil.GetStringConfig, workerutil.GetIntConfig, workerutil.GetStringSliceConfig
