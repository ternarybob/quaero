...
// LogWorker handles GitHub Action Log jobs and implements both DefinitionWorker and JobWorker interfaces.
// - DefinitionWorker: Creates parent jobs and spawns child jobs for workflow runs
// - JobWorker: Processes individual GitHub action log jobs
...
// Compile-time assertions: LogWorker implements both interfaces
var _ interfaces.DefinitionWorker = (*LogWorker)(nil)
var _ interfaces.JobWorker = (*LogWorker)(nil)

// NewLogWorker creates a new GitHub log worker that implements both DefinitionWorker and JobWorker interfaces
func NewLogWorker(
	connectorService interfaces.ConnectorService,
	jobManager *queue.Manager,
	queueMgr interfaces.QueueManager,
...
func (w *LogWorker) Execute(ctx context.Context, job *models.QueueJob) error {
...
func (w *LogWorker) findGitHubConnector(ctx context.Context) (*models.Connector, error) {
...
func (w *LogWorker) GetType() models.WorkerType {
...
func (w *LogWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
...
func (w *LogWorker) CreateJobs(ctx context.Context, step models.JobStep, jobDef models.JobDefinition, stepID string, initResult *interfaces.WorkerInitResult) (string, error) {
...
func (w *LogWorker) ReturnsChildJobs() bool {
	return true
}

// ValidateConfig validates step configuration for GitHub Actions type (DefinitionWorker interface)
func (w *LogWorker) ValidateConfig(step models.JobStep) error {
...
func (w *LogWorker) logDocumentSaved(ctx context.Context, job *models.QueueJob, docID, title, workflowName string) {
