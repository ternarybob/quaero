...
// RepoWorker handles GitHub repository jobs and implements both DefinitionWorker and JobWorker interfaces.
// - DefinitionWorker: Creates parent jobs and spawns child jobs for repository files
// - JobWorker: Processes individual GitHub repo file jobs
...
// Compile-time assertions: RepoWorker implements both interfaces
var _ interfaces.DefinitionWorker = (*RepoWorker)(nil)
var _ interfaces.JobWorker = (*RepoWorker)(nil)

// NewRepoWorker creates a new GitHub repo worker that implements both DefinitionWorker and JobWorker interfaces
func NewRepoWorker(
	connectorService interfaces.ConnectorService,
	jobManager *queue.Manager,
	queueMgr interfaces.QueueManager,
...
func (w *RepoWorker) Execute(ctx context.Context, job *models.QueueJob) error {
...
func (w *RepoWorker) GetType() models.WorkerType {
...
func (w *RepoWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
	...
	branches := workerutil.GetStringSliceConfig(stepConfig, "branches", []string{"main"})
...
func (w *RepoWorker) CreateJobs(ctx context.Context, step models.JobStep, jobDef models.JobDefinition, stepID string, initResult *interfaces.WorkerInitResult) (string, error) {
...
func (w *RepoWorker) ReturnsChildJobs() bool {
	return true
}

// ValidateConfig validates step configuration for GitHub repo type (DefinitionWorker interface)
func (w *RepoWorker) ValidateConfig(step models.JobStep) error {
...
func (w *RepoWorker) logDocumentSaved(ctx context.Context, job *models.QueueJob, docID, title, path string) {
