// -----------------------------------------------------------------------
// AssessorWorker - AI-powered stock assessment generation with validation
...
// AssessorWorker generates AI-powered stock assessments.
type AssessorWorker struct {
...
var _ interfaces.DefinitionWorker = (*AssessorWorker)(nil)

// NewAssessorWorker creates a new AI assessor worker
func NewAssessorWorker(
	documentStorage interfaces.DocumentStorage,
	kvStorage interfaces.KeyValueStorage,
	logger arbor.ILogger,
	jobMgr *queue.Manager,
...
func (w *AssessorWorker) GetType() models.WorkerType {
	return models.WorkerTypeMarketAssessor
}

// ReturnsChildJobs returns false - this worker executes inline
func (w *AssessorWorker) ReturnsChildJobs() bool {
	return false
}

// ValidateConfig validates the worker configuration
func (w *AssessorWorker) ValidateConfig(step models.JobStep) error {
	if step.Config == nil {
...
func (w *AssessorWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
	w.logger.Info().
		Str("phase", "init").
...
func (w *AssessorWorker) CreateJobs(ctx context.Context, step models.JobStep, jobDef models.JobDefinition, stepID string, initResult *interfaces.WorkerInitResult) (string, error) {
	if initResult == nil {
		var err error
...
func (w *AssessorWorker) loadSignals(ctx context.Context, tickers []string, tagPrefix string) map[string]signals.TickerSignals {
...
func (w *AssessorWorker) generateAssessments(ctx context.Context, batchSignals []signals.TickerSignals, holdingTypes map[string]string) ([]signals.TickerAssessment, error) {
	if w.llmService == nil {
...
func (w *AssessorWorker) buildPrompt(batchSignals []signals.TickerSignals, holdingTypes map[string]string) string {
...
func (w *AssessorWorker) parseAssessmentResponse(response string, batchSignals []signals.TickerSignals) ([]signals.TickerAssessment, error) {
...
func (w *AssessorWorker) generatePlaceholderAssessments(batchSignals []signals.TickerSignals, holdingTypes map[string]string) []signals.TickerAssessment {
...
func (w *AssessorWorker) validateWithRetry(ctx context.Context, assessment signals.TickerAssessment, sig signals.TickerSignals) signals.TickerAssessment {
...
func (w *AssessorWorker) storeAssessment(ctx context.Context, assessment signals.TickerAssessment, outputTags []string) error {
...
func (w *AssessorWorker) generateMarkdown(a signals.TickerAssessment) string {
	var sb strings.Builder
