// -----------------------------------------------------------------------
// DataCollectionWorker - Deterministic stock data collection
...
type DataCollectionWorker struct {
	*BaseMarketWorker // Embed for caching methods (GetDocument, GetDocuments)
	...
	marketDataWorker       *DataWorker // For index/benchmark data via EODHD
	directorInterestWorker *DirectorInterestWorker
	competitorWorker       *CompetitorWorker
}

// Compile-time assertion
var _ interfaces.DefinitionWorker = (*DataCollectionWorker)(nil)

// NewDataCollectionWorker creates a new stock data collection worker
// Parameters:
...
func (w *DataCollectionWorker) GetType() models.WorkerType {
	return models.WorkerTypeMarketDataCollection
}

// ValidateConfig validates step configuration
func (w *DataCollectionWorker) ValidateConfig(step models.JobStep) error {
...
func (w *DataCollectionWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
...
func (w *DataCollectionWorker) extractTickersFromVariables(config map[string]interface{}, tickerSet map[string]bool) {
...
func (w *DataCollectionWorker) extractTickersFromDocument(doc *models.Document) []string {
	var tickers []string
...
func (w *DataCollectionWorker) CreateJobs(ctx context.Context, step models.JobStep, jobDef models.JobDefinition, stepID string, initResult *interfaces.WorkerInitResult) (string, error) {
	if initResult == nil {
		var err error
...
func (w *DataCollectionWorker) createSummaryDocument(ctx context.Context, tickers []string, benchmarkCodes []string, totalDocs int, benchmarkWarnings []string, jobDef *models.JobDefinition, stepID string) *models.Document {
...
func (w *DataCollectionWorker) ReturnsChildJobs() bool {
	return false
}
