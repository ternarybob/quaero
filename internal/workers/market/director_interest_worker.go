// -----------------------------------------------------------------------
// DirectorInterestWorker - Fetches ASX director interest (Appendix 3Y) filings
...
// DirectorInterestWorker fetches ASX director interest filings (Appendix 3Y) and stores them as documents.
// This worker executes synchronously (no child jobs).
type DirectorInterestWorker struct {
...
// Compile-time assertion: DirectorInterestWorker implements DefinitionWorker interface
var _ interfaces.DefinitionWorker = (*DirectorInterestWorker)(nil)
...
func NewDirectorInterestWorker(
	...
	logger arbor.ILogger,
	jobMgr *queue.Manager,
) *DirectorInterestWorker {
	return &DirectorInterestWorker{
...
func (w *DirectorInterestWorker) GetType() models.WorkerType {
...
func (w *DirectorInterestWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
...
func (w *DirectorInterestWorker) CreateJobs(ctx context.Context, step models.JobStep, jobDef models.JobDefinition, stepID string, initResult *interfaces.WorkerInitResult) (string, error) {
...
func (w *DirectorInterestWorker) ReturnsChildJobs() bool {
	return false
}

// ValidateConfig validates step configuration for market_director_interest type
func (w *DirectorInterestWorker) ValidateConfig(step models.JobStep) error {
	if step.Config == nil {
...
func (w *DirectorInterestWorker) fetchDirectorInterest(ctx context.Context, asxCode, period string, limit int) ([]DirectorInterestFiling, error) {
...
func (w *DirectorInterestWorker) extractDirectorName(headline string) string {
...
func (w *DirectorInterestWorker) calculateCutoffDate(period string) time.Time {
	now := time.Now()
	switch period {
	case "D1":
...
func (w *DirectorInterestWorker) createDocument(ctx context.Context, filing DirectorInterestFiling, asxCode string, jobDef *models.JobDefinition, parentJobID string, outputTags []string) *models.Document {
...
func (w *DirectorInterestWorker) createNoFilingsDocument(ctx context.Context, asxCode string, jobDef *models.JobDefinition, parentJobID string, stepConfig map[string]interface{}) *models.Document {
	var content strings.Builder
