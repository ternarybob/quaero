// -----------------------------------------------------------------------
// MacroWorker - Fetches macroeconomic data (RBA rates, commodity prices)
...
// MacroWorker fetches macroeconomic data and stores it as documents.
...
// Compile-time assertion: MacroWorker implements DefinitionWorker interface
var _ interfaces.DefinitionWorker = (*MacroWorker)(nil)
...
// NewMacroWorker creates a new macro data worker
func NewMacroWorker(
	documentStorage interfaces.DocumentStorage,
	logger arbor.ILogger,
	jobMgr *queue.Manager,
...
func (w *MacroWorker) GetType() models.WorkerType {
	return models.WorkerTypeMarketMacro
}

// Init performs the initialization/setup phase for a macro data step.
func (w *MacroWorker) Init(ctx context.Context, step models.JobStep, jobDef models.JobDefinition) (*interfaces.WorkerInitResult, error) {
...
func (w *MacroWorker) CreateJobs(ctx context.Context, step models.JobStep, jobDef models.JobDefinition, stepID string, initResult *interfaces.WorkerInitResult) (string, error) {
...
func (w *MacroWorker) ReturnsChildJobs() bool {
	return false
}

// ValidateConfig validates step configuration for macro_data type
func (w *MacroWorker) ValidateConfig(step models.JobStep) error {
...
func (w *MacroWorker) fetchRBACashRate(ctx context.Context) ([]MacroDataPoint, error) {
...
func (w *MacroWorker) fetchRBAFromAPI(ctx context.Context) (float64, error) {
...
func (w *MacroWorker) fetchCommodityPrice(ctx context.Context, commodity string) ([]MacroDataPoint, error) {
	now := time.Now()
...
func (w *MacroWorker) fetchIronOrePrice(ctx context.Context) (float64, error) {
...
func (w *MacroWorker) fetchGoldPrice(ctx context.Context) (float64, error) {
...
func (w *MacroWorker) fetchYahooFinancePrice(ctx context.Context, symbol string) (float64, error) {
...
func (w *MacroWorker) createDocument(ctx context.Context, dataPoints []MacroDataPoint, jobDef *models.JobDefinition, parentJobID string, outputTags []string) *models.Document {
	now := time.Now()
