// -----------------------------------------------------------------------
// SignalWorker - Computes signals from stock collector data
...
// SignalWorker computes signals from existing stock data documents.
...
// NewSignalWorker creates a new signal computer worker
...
func (w *SignalWorker) processSignals(ctx context.Context, ticker common.Ticker, stepID string, outputTags []string) (*signalDocInfo, error) {
...
func (w *SignalWorker) loadBenchmarkReturns(ctx context.Context) map[string]float64 {
...
func (w *SignalWorker) extractTickerRaw(asxCode string, doc *models.Document) (signals.TickerRaw, error) {
...
func (w *SignalWorker) generateMarkdown(ticker string, s signals.TickerSignals) string {
